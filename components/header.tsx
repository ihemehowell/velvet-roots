    ...
    <header className="sticky top-0 z-40 border-b border-border bg-ivory/95 backdrop-blur">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 md:px-8">
        ...
        <div className="flex items-center gap-4">
          <button aria-label="Search" className="hover:text-bronze">
            <Search className="h-5 w-5" />
          </button>
          <button aria-label="Open cart" onClick={openCart} className="relative hover:text-bronze">
      ...
      <div className={cn("md:hidden overflow-hidden transition-all", mobileOpen ? "max-h-40" : "max-h-0")}>
